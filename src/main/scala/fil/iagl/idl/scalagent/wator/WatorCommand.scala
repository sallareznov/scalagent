...
object WatorCommand extends Command(name = "wator", description = "blabla") {
  ...
  // -> command arguments
  var width = opt[Int](name = "width", default = 150, description = "the width of the grid representing the environment")
  var height = opt[Int](name = "height", default = 150, description = "the height of the grid representing the environment")
