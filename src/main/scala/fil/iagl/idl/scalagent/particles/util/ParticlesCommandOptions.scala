package fil.iagl.idl.scalagent.particles.util

import org.backuity.clist._

object ParticlesCommandOptions extends Command(name = "particles", description = "simulates a bubble chamber using a multi-agent approach") {

  // -> command arguments
  var nbParticles = opt[Int](name = "nbParticles", default = 10000, description = "the number of particles in the room [default = 10000]")
  var envWidth = opt[Int](name = "envWidth", default = 600, description = "the width of the grid representing the environment [default = the width of the screen]")
  var envHeight = opt[Int](name = "envHeight", default = 600, description = "the height of the grid representing the environment [default = the height of the screen]")
  ...
  var speed = opt[Int](name = "speed", default = 25, description = "the speed of the game (i.e. the number of milliseconds per lap [default = 25]")
