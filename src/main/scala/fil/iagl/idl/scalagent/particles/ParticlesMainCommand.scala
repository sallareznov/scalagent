...
class ParticlesMainCommand() extends CommandWithHandling(description = "simulates a bubble chamber using a multi-agent approach") {
  ...
  var nbParticles = opt[Int](name = "nbParticles", default = 1000, description = "the number of particles in the room")
  var envSize = opt[Int](name = "envSize", default = 800, description = "the size of the grid representing the environment")
  var agentSize = opt[Int](name = "agentSize", default = 10, description = "the size of the agent (in pixels)")
  var speed = opt[Int](name = "speed", default = 500, description = "the speed of the game (i.e. the number of milliseconds per lap")
