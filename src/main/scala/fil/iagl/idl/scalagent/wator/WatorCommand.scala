...
object WatorCommand extends Command(name = "wator", description = "blabla") {
  ...
  var nTunas = opt[Int](name = "nTunas", default = 10000, description = "the number of fishes in the environment, distributed randomly")
  var nSharks = opt[Int](name = "nSharks", default = 5000, description = "the number of sharks in the environment, distributed randomly")
  var tBreed = opt[Int](name = "tBreed", default = 7, description = "the number of cycles a fish must exist before reproducing")
